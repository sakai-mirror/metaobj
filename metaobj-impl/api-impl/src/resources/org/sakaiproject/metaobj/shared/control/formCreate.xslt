            ...
            <div class="portletBody">
               ...
               <form method="post" onsubmit="a=1;">
                  ...
                  <label for="displayName"><xsl:value-of
                     select="sakaifn:getMessage('messages', 'display.name.label')" /> </label>
                  <xsl:choose>
                  ...
                  <div>
                     ...
                     <xsl:choose>
                        <xsl:when test="$subForm = 'true'">
                           <input type="submit" name="updateNestedButton" alignment="center">
                              <xsl:attribute name="value"><xsl:value-of
                                 select="sakaifn:getMessage('messages', 'button_update')" /></xsl:attribute>
                           </input>
                        ...
                        <xsl:otherwise>
                           <input type="submit" name="submitButton" alignment="center">
                              <xsl:attribute name="value"><xsl:value-of
                                 select="sakaifn:getMessage('messages', 'button_saveEdit')" /></xsl:attribute>
                           </input>
                           <input type="submit" name="cancel">
                              <xsl:attribute name="value"><xsl:value-of
                                 select="sakaifn:getMessage('messages', 'button_cancel')" /></xsl:attribute>
