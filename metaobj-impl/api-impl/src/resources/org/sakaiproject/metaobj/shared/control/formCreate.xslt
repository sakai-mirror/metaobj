...
<xsl:stylesheet version="2.0" xmlns="http://www.w3.org/1999/xhtml"
	...
	<xsl:output method="html" version="4.0" cdata-section-elements="" encoding="iso-8859-1"
		indent="yes"/>
	...
	<xsl:template match="formView">
		...
		<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
			...
			<body>
				<xsl:if test="$panelId">
					<xsl:attribute name="onLoad">setMainFrameHeight('<xsl:value-of select="$panelId"
   ...
   -->
	<xsl:template
		match="element[xs:simpleType/xs:restriction[@base='xs:string']/xs:maxLength[@value>99]]">
		<xsl:param name="currentParent"/>
		<xsl:param name="rootNode"/>
   ...
   -->
	<xsl:template
		match="element[xs:annotation/xs:documentation[@source='ospi.isRichText' or @source='sakai.isRichText']]">
		<xsl:param name="currentParent"/>
		<xsl:param name="rootNode"/>
